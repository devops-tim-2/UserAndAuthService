...
class TestUpdate:
    ...
    def test_update_happy(self):
        ...
        cjanged_data = { "username": "user123","password": "password","age": 29,"sex": "F","region": "na","interests": "sport, stiropor, sve lepo","bio": "test profile 1.","website": "http://www.google.com/","phone": "066345345","profile_image_link": "","public": False,"taggable": False }
